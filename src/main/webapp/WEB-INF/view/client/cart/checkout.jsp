                                    ...
                                    <tbody>
                                        <c:forEach var="cartDetail" items="${cartDetails}">
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="mb-0 mt-4">${cartDetail.quantity}</p>
                                                </td>
                                                <td>
                                                    <p class="mb-0 mt-4">
                                    ...
                                    <div class="mt-5 row g-4">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="p-4">
                                                ...
                                                <div class="row">
                                                    <div class="form-item">
                                                        <label class="form-label my-3">Tên người
                                                            nhận<sup>*</sup></label>
                                                    ...
                                                    <div class="form-item">
                                                        <label class="form-label my-3">Địa chỉ nhận
                                                            hàng<sup>*</sup></label>
                                                    ...
                                                    <div class="form-item">
                                                        <label class="form-label my-3">Điện thoại người
                                                            nhận<sup>*</sup></label>
                                        ...
                                        <!-- Cột phải: Thông tin thanh toán — đẩy sang phải bằng ms-auto -->
